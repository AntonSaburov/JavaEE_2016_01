...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext(new String[]{"springDatabase.xml"});

        JdbcTemplate jdbc = context.getBean("jdbcTemplate", JdbcTemplate.class);

        Long countOfRegion = jdbc.queryForObject("select count(*) from jc_region", Long.class);
        ...
        String regionName = jdbc.queryForObject("select region_name from jc_region "
            ...
            new Object[]{5L, "Region:1456366497960"}, String.class);
